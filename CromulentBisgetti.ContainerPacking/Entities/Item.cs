...
namespace CromulentBisgetti.ContainerPacking.Entities
{
	...
	public class Item
	{
        ...
        /// <param name="tag">Tag of an item.</param>
        public Item(int id, decimal dim1, decimal dim2, decimal dim3, int quantity, string tag)
		{
			this.ID = id;
			this.Dim1_x = dim1;
			this.Dim2_z = dim2;
